...
## Fine print: 
  ...
  * Scoring: 1 point per hour of the proposed initinerary if the flights arrive on time at the destination, -100 per proposed itinerary that does not arrive on time or is cancelled
