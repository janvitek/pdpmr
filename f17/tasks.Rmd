...
<8,10)% of the corpus, its score is **1**. If it makes up <6,8)%, its score is
**2**. If it makes up <4,6)%, its score is **4**. If it makes up <2,4)%, its
score is **8**.  If the letter makes up <1,2)%, its score is **16**. Otherwise,
the score is **32**. Whitespaces, nbumbers, and punctuation do not receive
scores. Scoring is case-insensitive.
...
returns the mean score of *w*'s neighborhoods.
...
Compare the performance of the sequential scorer and the parallel scorer. Use
top 100 books of Project Gutenberg as input
