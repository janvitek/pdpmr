...
(NEU/normil) GitHub and share the repository with the instructors and TA:
`janvitek`, `aviralg`, `kondziu`.
...
**Not adhering to the prescribed structure will be penalized.**
